...
// I assumed people had to be an important figure in their community to be able to run such as a Teacher // or a TD but it turns out people can also run if they are Unemployed which gives a better chance for
// people with ideas to become elected even if they aren't exactly well-known.